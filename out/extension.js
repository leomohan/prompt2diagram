...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('prompt2diagram.helloWorld', () => {
        const panel = vscode.window.createWebviewPanel('prompt2diagram', 'Prompt2Diagram', vscode.ViewColumn.One, {
            enableScripts: true,
        });
        ...
        panel.webview.onDidReceiveMessage((message) => {
            if (message.type === 'prompt') {
                ...
                const mermaidSyntax = (0, parser_1.parsePromptToMermaid)(userInput);
