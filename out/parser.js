...
exports.parsePromptToMermaid = parsePromptToMermaid;
const keywordMap = {
    "router": "Router",
    "firewall": "Firewall",
    "vpn": "VPN",
...
function parsePromptToMermaid(prompt) {
